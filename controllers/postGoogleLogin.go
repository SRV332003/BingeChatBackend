...
func VerifyAuthCode(c *gin.Context) {
	...
	if !exists || err != nil {
		utils.SendErrorResponse(c, 403, "Your email doesn't match with any college. Please use your college email or register your college first if already using college email.")
		return
	}
